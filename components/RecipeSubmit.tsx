...
export default function RecipeSubmit() {
	return (
        ...
        <section className={styles.recipeSubmit__grid}>
			...
			<a href="https://docs.google.com/forms/d/e/1FAIpQLSfTL-vfsnWmBadCLCoK0ShkHOw737W5NBXDelwc-d_-eIrFlw/viewform" target="_blank" rel="noreferrer" className="btn btn--green">Hey, das wäre toll!</a>
		</section>
		</>
  )
}